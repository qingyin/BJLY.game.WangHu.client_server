...
void NNGameScence::initPrivate()
{
	...
	WidgetManager::addButtonCB("XZDDButton_WeiXinFriend",this,button_selector(NNGameScence::XZDDButton_WeiXinFriend));
	WidgetManager::addButtonCB("XZDDButton_WeiXinImagic",this,button_selector(NNGameScence::XZDDButton_WeiXinImagic));
...
void NNGameScence::XZDDButton_WeiXinFriend(cocos2d::Ref*,WidgetUserInfo*)
{
	...
	MissionWeiXin::Instance().shareUrlWeiXin(utility::getScriptString("NNWeiXinSharUrl"),
		...
		utility::getScriptReplaceValue("NNPrivateTxt1",WidgetFun::getText(this,"RoomID")),
