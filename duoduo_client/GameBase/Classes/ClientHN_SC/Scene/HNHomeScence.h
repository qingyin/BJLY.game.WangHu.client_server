...
public:
	...
	void Button_SetChannel(cocos2d::Ref*,WidgetUserInfo*);
public:
	void Req_UserInfo(std::string kChannel);
	void Rsp_UserInfo(std::string kStr);
	void Req_FangKaInfo(std::string kChannel);
	void Rsp_FangKaInfo(rapidjson::Document* pDoc);
public:
	void NextSpeaker();
