...
bool NCPrivateScenceNC::init()
{
	...
	WidgetManager::addButtonCB("Button_GameRule3",this,button_selector(NCPrivateScenceNC::ButtonGameRule));
	WidgetManager::addButtonCB("Button_GameRule4",this,button_selector(NCPrivateScenceNC::ButtonGameRule));
	...
	FvMask::Add(m_dwPlayRule,_MASK_((dword)GAME_TYPE_ZZ_ZIMOHU));
	return true;
}
...
void NCPrivateScenceNC::Button_CreateRoom(cocos2d::Ref*,WidgetUserInfo*)
{
	...
	ConnectAndCreatePrivateByKindID(NCMJGameScence::KIND_ID,kSendNet);
}
