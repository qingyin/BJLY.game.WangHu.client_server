...
bool HNPrivateScenceHN::init()
{
	...
	WidgetManager::addButtonCB("Button_GameRule5_CS",this,button_selector(HNPrivateScenceHN::ButtonGameRuleCS));
	WidgetManager::addButtonCB("Button_GameRule6_CS",this,button_selector(HNPrivateScenceHN::ButtonGameRuleCS));
	WidgetManager::addButtonCB("Button_GameRule7_CS",this,button_selector(HNPrivateScenceHN::ButtonGameRuleCS));
...
void HNPrivateScenceHN::setGameRuleIdex_CS(int iIdex)
{
	if (iIdex == GAME_TYPE_ZZ_ZHANIAO2)
	{
		FvMask::Del(m_dwPlayRule,_MASK_((dword)GAME_TYPE_ZZ_ZHANIAO4));
...
void HNPrivateScenceHN::updateGameRule_CS()
{

	WidgetFun::setChecked(this,"Button_GameRule2",FvMask::HasAny(m_dwPlayRule,_MASK_((dword)GAME_TYPE_CS_ZHUANGXIANFEN)));

	WidgetFun::setChecked(this,"Button_GameRule5_CS",FvMask::HasAny(m_dwPlayRule,_MASK_((dword)GAME_TYPE_ZZ_ZHANIAO2)));
	WidgetFun::setChecked(this,"Button_GameRule6_CS",FvMask::HasAny(m_dwPlayRule,_MASK_((dword)GAME_TYPE_ZZ_ZHANIAO4)));
	WidgetFun::setChecked(this,"Button_GameRule7_CS",FvMask::HasAny(m_dwPlayRule,_MASK_((dword)GAME_TYPE_ZZ_ZHANIAO6)));
}

void HNPrivateScenceHN::ButtonGameRuleCS(cocos2d::Ref*,WidgetUserInfo* pUserInfo)
{
	int iIdex = utility::parseInt(WidgetFun::getUserInfoValue(pUserInfo,"Idex"));
	setGameRuleIdex_CS(iIdex);
}
