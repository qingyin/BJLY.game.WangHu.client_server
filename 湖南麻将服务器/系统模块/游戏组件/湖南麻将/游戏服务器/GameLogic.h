...
#define WIK_LISTEN					0x00000400								//叫牌
...
#define CHR_HAOHUA_QI_XIAO_DUI				0x00000040									//豪华七小对 --- 龙七对
#define CHR_GANG_KAI						0x00000080									//杠上开花
#define CHR_QIANG_GANG_HU					0x00000100									//抢杠胡
#define CHR_GANG_SHANG_PAO					0x00000200									//杠上炮
#define CHR_QUAN_QIU_REN					0x00000400									//全求人
#define CHR_SHUANG_HAOHUA_QI_XIAO_DUI		0x00000800									//双豪华七小对   ---  双龙七对
...
/************************************************************************/
/* 2017年3月17日16:27:15 添加	平胡/青大对								*/
/************************************************************************/
#define CHR_XIAO_Hu							0x00040000									//小胡
#define CHR_Qing_Da_Dui						0x00080000									//青大对
...
protected:
	...
	std::vector<int>				tingCardData;							//听牌数据

public:
	void setTingCardVector(std::vector<int> m_TingCardIndex);
	std::vector<int> getTingCardVector();
