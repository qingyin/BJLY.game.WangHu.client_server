...
#define GAME_TYPE_ZZ				0  // 转转麻将
#define GAME_TYPE_CS				1  // 长沙麻将
...
//Test
#define GAME_TYPE_ZZ_ZZ				18		//转转玩法
#define GAME_TYPE_CS_HUPAIZHUANG	19		//胡牌为庄
#define GAME_TYPE_CS_ZHANIAO_1FEN	20		//扎鸟+1分
#define GAME_TYPE_CS_NIAOJIANIAO	21		//鸟加鸟
...
#define	SUB_S_LISTEN_CARD			115									//听牌
...
//听牌命令
struct CMD_S_TingCard
{
	WORD							wTingCardUser;						//听牌用户
	bool							isTingCard;							//是否听牌
	//std::vector<int>				tingCardVector;						//听牌数组
};
